...
export default function ProductView() {
  ...
  if (loading) return <p className="text-white/60">Loading product...</p>;
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.05] shadow-2xl">
        <AdminImageCarousel item={item} title={item.name || "Product"} />

        <div className="p-8">
          <div className="mb-5 flex flex-wrap gap-3">
            <span className="inline-flex items-center gap-2 rounded-full bg-violet-500/20 px-4 py-2 text-sm font-bold text-violet-100">
          ...
          <h1 className="text-4xl font-black md:text-5xl">{item.name}</h1>
